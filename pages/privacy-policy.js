function privacyPolicy() {
  return (
    <div className="my-10 mx-auto max-w-4xl p-8">
      ...
      <p>
        Red Ink built the Tech: Mobile PC Gadget Review app as a Free app. This
        SERVICE is provided by Red Ink at no cost and is intended for use as is.
      </p>{' '}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at Tech: Mobile PC Gadget
        Review unless otherwise defined in this Privacy Policy.
      </p>{' '}
      <p>
      ...
      <p>
        ...
        but not limited to Email, Number , Name. The information that I request
      ...
      <p>This policy is effective as of 2022-04-14</p>{' '}
      <p>
        <strong>Contact Us</strong>
      </p>{' '}
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at contacttechreview9@gmail.com.
      </p>
    </div>
  )
}
