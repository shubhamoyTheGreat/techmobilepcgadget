function termsAndCondition() {
  return (
    <div className="my-10 mx-auto max-w-4xl p-8">
      ...
      <p>
        ...
        other intellectual property rights related to it, still belong to Red
        Ink.
      </p>{' '}
      <p>
        Red Ink is committed to ensuring that the app is as useful and efficient
      ...
      <p>
        The Tech: Mobile PC Gadget Review app stores and processes personal data
        ...
        phone’s security features and it could mean that the Tech: Mobile PC
        Gadget Review app won’t work properly or at all.
      </p>{' '}
      <div>
        <p>
        ...
        <ul>
          ...
          <li>
            <a
              className="font-semibold text-blue-600 hover:text-blue-900"
              href="https://www.startapp.com/policy/publisher-terms/"
              target="_blank"
              rel="noopener noreferrer"
            >
              StartApp
      ...
      <p>
        You should be aware that there are certain things that Red Ink will not
        ...
        or provided by your mobile network provider, but Red Ink cannot take
      ...
      <p>
        Along the same lines, Red Ink cannot always take responsibility for the
        ...
        the Service, Red Ink cannot accept responsibility.
      </p>{' '}
      <p>
        With respect to Red Ink’s responsibility for your use of the app, when
        ...
        it available to you. Red Ink accepts no liability for any loss, direct
      ...
      <p>
        ...
        using the app. Red Ink does not promise that it will always update the
      ...
      <p>These terms and conditions are effective as of 2022-04-14</p>{' '}
      <p>
        <strong>Contact Us</strong>
      </p>{' '}
      <p>
        If you have any questions or suggestions about my Terms and Conditions,
        do not hesitate to contact me at contacttechreview9@gmail.com.
      </p>
    </div>
  )
}
